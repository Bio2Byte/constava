...
def parse_parameters(cmdline_arguments):
    ...
    gen_opt = parser.add_argument_group("Generic options")
    ...
    #  Subparser: fit-model
    # ======================
    parser_fit_model = subparsers.add_parser(
        "fit-model",
        description=tw.dedent(
            """\
    ...
    fit_io = parser_fit_model.add_argument_group("Input and output options")
    fit_io.add_argument(
        "-i",
        "--input",
        type=str,
    ...
    fit_mdl = parser_fit_model.add_argument_group("Conformational state model options")
    fit_mdl.add_argument(
        "--model-type",
        choices=["kde", "grid"],
        default="kde",
        help=tw.dedent(
    ...
    ana_io = parser_analyze.add_argument_group("Input & output options")
    ana_io.add_argument(
        "-i",
        "--input",
        nargs="+",
    ...
    ana_io.add_argument(
        "--output-format",
        choices=["auto", "csv", "json", "tsv"],
        default="auto",
        help="Format of output file: {'csv', 'json', 'tsv'}. (default: 'auto')",
    )

    ana_mdl = parser_analyze.add_argument_group("Conformational state model options")
    ana_mdl.add_argument(
        "-m",
        "--load-model",
        type=str,
        metavar="<file.pkl>",
    ...
    ana_smpl = parser_analyze.add_argument_group("Sub-sampling options")
    ana_smpl.add_argument(
        "--window",
        metavar="<int>",
        type=int,
        nargs="+",
    ...
    ana_misc = parser_analyze.add_argument_group("Miscellaneous options")
    ana_misc.add_argument(
        "--degrees",
        action="store_true",
        help=tw.dedent(
            """\
    ...
    ana_misc.add_argument(
        ...
        default=None,
        required=False,
        help="Set random seed for bootstrap sampling",
    )
    ana_misc.add_argument(
        "-v",
        "--verbose",
    ...
    # Subparser: dihedrals
    # =====================
    parser_dihedrals = subparsers.add_parser(
        "dihedrals",
        description=tw.dedent(
            """\
    ...
    dih_io = parser_dihedrals.add_argument_group("Input & output options")
    dih_io.add_argument(
        "-s",
        "--structure",
        metavar="<file.pdb>",
    ...
    dih_misc = parser_dihedrals.add_argument_group("Input & output options")
    dih_misc.add_argument(
        "--selection",
        default="protein",
